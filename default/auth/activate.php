	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="loginmodal-container">
				<h1><?=$data['lang_activateaccount']?></h1><br>

				<form class="" action="activate" method="post">
					<?php if(isset($_POST['submit'])) { ?>
					<div class="alert alert-success">Your account has been activated! You may now log in using your credentials.</div>
					<?php } ?>
					<p><input class="form-control" type='text' name='username' placeholder="<?=$data['lang_username']?>"></p>
					<p><input class="form-control" type='text' name='code' placeholder="<?=$data['lang_activationcode']?>"></p>
					<p><button class="login loginmodal-submit" type='submit' name='submit'><?=$data['lang_activate']?></button></p>
					<div class="login-help">
						<a href="login"><?=$data['lang_login']?></a> - <a href="register"><?=$data['lang_createaccount']?></a>
					</div><br>
